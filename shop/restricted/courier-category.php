...
?>
				...
				<!-- /main-header -->
                       ...
                       <div class="col-md-12">
                                            <div class="form-group">
                                             <?php
											include("includes/courier-category-setup.php");
							...
							<div class="card mg-b-20">
								<div class="card-header pb-0">
									<div class="d-flex justify-content-between">
										<h4 class="card-title mg-b-0">Courier Category SetUp</h4>
										<i class="mdi mdi-dots-horizontal text-gray"></i>
									</div>
									<p class="tx-12 tx-gray-500 mb-2">Courier Category Information</p>
								</div>
								<div class="card-body">
 ...
 <input type="text" class="form-control" id="exampleInputuname_1" placeholder="Courier Category Name" name="name" value="<?php 	 if(isset($_GET['value']))
	 { echo $name; } ?>" c>
												</div>
											  <div class="form-group overflow-hidden">
													<label>Description:</label>
 <input type="text" class="form-control" id="exampleInputEmail_1"  name="desc" placeholder="Courier Category Description" value="<?php 	 if(isset($_GET['value']))
	 { echo $desc;} ?>" required>
												</div>
                            
                            <div class="form-group overflow-hidden">
													<label>Courier Category Image:</label>
 <input type="file" class="form-control" id="exampleInputEmail_1"  name="image" placeholder="Courier Category Image" value="<?php 	 if(isset($_GET['value']))
	 { echo $desc;} ?>" required>
												</div>
...
<br>
						...
						<div class="col-xl-12">
							<div class="card mg-b-20">
								<div class="card-header pb-0">
									<div class="d-flex justify-content-between">
										<h4 class="card-title mg-b-0">Courier Category Information</h4>
										<i class="mdi mdi-dots-horizontal text-gray"></i>
									</div>
									<p class="tx-12 tx-gray-500 mb-2">Courier Category Information</p>
								</div>
								<div class="card-body">
									<div class="table-responsive">
                                        ...
                                        <tbody>
                                         <?php
												include("includes/view-courier-category.php");
