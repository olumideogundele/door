...
$emailing  = $_SESSION['email'];
     ...
     $truck_max_number =  $myName->showName($conn, "SELECT `number` FROM `user_unit`  WHERE (`account_number` = '$emailing')");
     $added_truck =  $myName->showName($conn, "SELECT COUNT(`id`) FROM `truck`  WHERE (`account_number` = '$emailing' AND `status` = 1)");
