...
if($super == "1")
{
	 ...
	 $query =  "SELECT `id`, `name`, `account_number`, `phone`, `email`, `address`, `usertype`,`created_date`, `registeredby`, `status`,`irrelivant` ,`designation`, `ministry` FROM `user_unit` WHERE    `usertype` = '4' AND `status` = '$id' ORDER BY `id` DESC";
...
else 
{
	 ...
	 $query =  "SELECT `id`, `name`, `account_number`, `phone`, `email`, `address`, `usertype`,`created_date`, `registeredby`, `status`,`irrelivant` ,`designation`, `ministry` FROM `user_unit` WHERE (`super` != 1 AND `usertype` = '4'  AND `registeredby` = '$emailing' AND `status` = '$id') ORDER BY `id` DESC";	
...
if($super == "1")
{
	 ...
	 $query =  "SELECT `id`, `name`, `account_number`, `phone`, `email`, `address`, `usertype`,`created_date`, `registeredby`, `status`,`irrelivant` ,`designation`, `ministry` FROM `user_unit` WHERE    `usertype` = '4' ORDER BY `id` DESC";
...
else 
{
	 ...
	 $query =  "SELECT `id`, `name`, `account_number`, `phone`, `email`, `address`, `usertype`,`created_date`, `registeredby`, `status`,`irrelivant` ,`designation`, `ministry` FROM `user_unit` WHERE (`super` != 1 AND `usertype` = '4'  AND `registeredby` = '$emailing') ORDER BY `id` DESC";	
