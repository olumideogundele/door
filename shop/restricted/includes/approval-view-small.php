...
if(isset($_GET['code']))
 ...
 $query =  "SELECT  `id`, `filepath`, `filename`, `ministry`, `agency`, `directoryname`, `shelf`, `shelf_cell`, `name`, `file_type`, `status`, `registry`, `created_date`, `creeated_by`, `filesize`, `filecode`, `submitted_by`, `stage`,`type`, `account_name`, `account_number`, `bank_name`, `amount` FROM `userfiles`  WHERE (`group_code` = '$code' or `filecode` = '$code') or (`group_code` = '$code2' or `filecode` = '$code2') ";	
