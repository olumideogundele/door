...
$sql = "INSERT INTO `income_category`(`super_category`, `code`, `name`, `desc`, `status`, `created_date`, `registeredby`) VALUES
('$category','$code','$name', '$desc_text', '$status','$datetime','$emailing')";
