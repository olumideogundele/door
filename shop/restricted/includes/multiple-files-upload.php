...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
		    <h4 class="page-title">Digital Files Uploads</h4>
		    <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javaScript:void();">Dashtreme</a></li>
            <li class="breadcrumb-item"><a href="javaScript:void();">Upload</a></li>
            <li class="breadcrumb-item active" aria-current="page">Digital Files Uploads</li>
         </ol>
	   </div>
 ...
 // echo rtf2text("file.rtf");
   ...
   echo $response;
			   ...
			   include("includes/notification-file-approval.php");
					   ?>
                    </div>
          ...
          <div class="card">
			     ...
			     <div class='content'>
            <form action="upload.php" class="dropzone"      method="post"    autocomplete="off">
				
						
	 
	 <div class="form-group">
                      <label>Registry/Department:</label>
                   <select class="form-control single-select" name="registry" required>
														<option value="">---Select One---</option>
													  <?php
	 include("config/DB_config.php");
	 
	 
	 $query =  "SELECT `id`, `name`  FROM `mda`  WHERE `status` = 1 AND `name` != '' ORDER BY `id` ASC";	
 	 ...
 	 while ($row_distance=mysqli_fetch_row($extract_distance))
    {
	 ...
	 ?>
                 ...
                 <label>Requisition Name:</label>
				   ...
				   <input type="text"   name="name" class="form-control" id="name" placeholder="e.g. invite-001W" required>
                 ...
                 <label>Document From :</label>
				   ...
				   <input type="text"   name="from" class="form-control" id="from" placeholder="e.g. Tinuten Nigeria Limited" required>
					   
				   </div>
				
				 <div class="card-header text-uppercase">Multiple File Uploads -:  
<span style="font-size: 10px;"> <span class="bg-danger" style="color: aliceblue; padding: 10px;">Note:</span> <!--Please, App Supports the following types of files 
(.jpg, .jpeg, .png, .gif. pdf. doc, .docx, "xlsx","xls"). --></span> </div>
        
           
              
<!--
            <input type="submit" id='uploadfiles' name="validate" value='Upload Files' class="btn-social-text btn-outline-twitter waves-effect waves-light m-1" > -->
					 </form>  
          </div>
        </div>
      </div><!--End Row-->
<!--start overlay-->
 ...
 <!--End content-wrapper-->
  ...
  <script src="upload-multiple/jquery-3.3.1.min.js" type="text/javascript"></script>
 <!--       <script src="upload-multiple/dropzone/dist/min/dropzone.min.js" type="text/javascript"></script>-->
