...
$sql = 	 "UPDATE `registry` SET  `name` = '$name', `information` = '$information', `status` = '$status', `created_date` = '$datetime', `registeredby` = '$emailing'  WHERE `name` = '$name'";
...
$sql = 	 "INSERT INTO `registry`(`name` ,`information` , `status`, `created_date`, `registeredby`) VALUES
('$name',  '$information',  '$status', '$datetime', '$emailing')";
