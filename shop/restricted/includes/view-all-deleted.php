...
$usertype = $_SESSION['usertype']; 
	 ...
	 $query2 =  "SELECT `id`, `filecode`, `created_date`, `created_by` FROM `deleted` ORDER BY `id` DESC";
...
$statusParam = "Deleted";
 ...
 <td> <span class="'.$statusCSS.'">'.$statusParam.'</span> </td>
 				 <td>
									 ...
									 <a class="dropdown-item"  onClick="return confirm(\'Are you sure you want to delete?\')" href="?table=userfiles&del='.$id.'"> Delete Permanently </a> 
