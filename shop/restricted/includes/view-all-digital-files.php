...
if($usertype == "1")
{
	 ...
	 $query1 =  "SELECT  `id`, `filepath`, `filename`, `ministry`, `agency`, `directoryname`, `shelf`, `shelf_cell`, `name`, `file_type`, `status`, `registry`, `created_date`, `creeated_by`, `filesize`, `filecode`, `submitted_by`, `stage`, `select_stakeholder`, `group_code` FROM `userfiles` WHERE `file_type` = 'digital' AND `status_a` = '1' AND `registry` = '$mdas'  ORDER BY `id` DESC";
	...
	}else
{
	 ...
	 $query1 =  "SELECT  `id`, `filepath`, `filename`, `ministry`, `agency`, `directoryname`, `shelf`, `shelf_cell`, `name`, `file_type`, `status`, `registry`, `created_date`, `creeated_by`, `filesize`, `filecode`, `submitted_by`, `stage`, `select_stakeholder`, `group_code` FROM `userfiles` WHERE `file_type` = 'digital' AND `status_a` = '1' AND `creeated_by` = '$emailing'  ORDER BY `id` DESC";
