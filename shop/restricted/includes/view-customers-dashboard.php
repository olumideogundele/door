...
include ("config/DB_config.php"); 
 ...
 $counter = 1;
	 ...
	 $query =  "SELECT `id`, `name`, `account_number`, `phone`, `email`, `address`, `usertype`,`created_date`, `registeredby`, `status`,`irrelivant` ,`designation`, `file` FROM `user_unit` WHERE    `usertype` = '3'   ORDER BY `id` DESC LIMIT 5";
