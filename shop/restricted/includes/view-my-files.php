...
$statusParam = "Not Successful";
 ...
 {
	 $type =$_GET['type'];
	 $query1 =  "SELECT  `id`, `filepath`, `filename`, `ministry`, `agency`, `directoryname`, `shelf`, `shelf_cell`, `name`, `file_type`, `status`, `registry`, `created_date`, `creeated_by`, `filesize`, `filecode`, `submitted_by`, `stage`, `select_stakeholder`, `group_code` FROM `userfiles` WHERE  (`filecode` = '$code' or `group_code` = '$code')  AND  `file_type` = '$type' ORDER BY `id` DESC"; 
 }
		 else
		 {
		$query1 =  "SELECT  `id`, `filepath`, `filename`, `ministry`, `agency`, `directoryname`, `shelf`, `shelf_cell`, `name`, `file_type`, `status`, `registry`, `created_date`, `creeated_by`, `filesize`, `filecode`, `submitted_by`, `stage`, `select_stakeholder`, `group_code` FROM `userfiles` WHERE  (`filecode` = '$code' or `group_code` = '$code')  ORDER BY `id` DESC"; 
