...
if($usertype != "1")
{
	 ...
	 $query =  "SELECT `id`, `name`, `account_number`, `phone`, `email`, `address`, `usertype`,`created_date`, `registeredby`, `status`,`irrelivant` ,`designation`, `ministry` FROM `user_unit` WHERE (`account_number` = '$emailing') AND `usertype`  = '2' AND  `super` != 1 ORDER BY `id` DESC";
...
else 
{
	 ...
	 $query =  "SELECT `id`, `name`, `account_number`, `phone`, `email`, `address`, `usertype`,`created_date`, `registeredby`, `status`,`irrelivant` ,`designation`, `ministry` FROM `user_unit` WHERE `super` != 1 AND `usertype`  = '2'    ORDER BY `id` DESC";	
...
$statusParam = "Blocked";
		...
		else if($usertype == 2)
		{
				...
				$usertypeValue = "Truck Owner";
		}
		else if($usertype == 3)
		{
			
				$usertypeValue = "Subscribers";
		}
