...
if($usertype != "1" or $super != "1")
{
	 ...
	 $query =  "SELECT `id`, `name`, `account_number`, `phone`, `email`, `address`, `usertype`,`created_date`, `registeredby`, `status`,`irrelivant` ,`designation`, `ministry` ,`state`, `lga` , `branch` FROM `user_unit` WHERE (`account_number` = '$emailing' AND `registeredby` = '$emailing') AND `usertype` != '1' AND `usertype` != 2 AND `usertype` != 3 AND `usertype` != 4 AND  `super` != 1 ORDER BY `id` DESC";
...
else 
{
	 ...
	 $query =  "SELECT `id`, `name`, `account_number`, `phone`, `email`, `address`, `usertype`,`created_date`, `registeredby`, `status`,`irrelivant` ,`designation`, `ministry` ,`state`, `lga` , `branch` FROM `user_unit` WHERE ( `super` != 1 AND `usertype` != 1 AND `usertype` != 2 AND `usertype` != 3 AND `usertype` != 4) ORDER BY `id` DESC";	
