...
if($usertype != "1")
{
 ...
 $query =  "SELECT `id`, `amount`, `account_number`, `registeredby`, `status`, `created_date`, `updated_at`, `tcode`, `remark`  FROM `e_wallet` WHERE `account_number` = '$emailing' ORDER BY `id` DESC";
