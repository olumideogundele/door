...
<html lang="en">
	...
	<body class="error-page1 main-body dark-theme">
								...
								<div class="row">
									<div class="col-md-10 col-lg-10 col-xl-9 mx-auto">
										<div class="card-sigin">
											<div class="mb-5 d-flex"> <a href="backend/index.html"><img     src="<?php
														if(isset($inst_logo))
														{
															echo $inst_logo;
														}
														...
														?>" class="sign-favicon ht-40" alt="logo"></a><h1 class="main-logo1 ml-1 mr-0 my-auto tx-28">Va<span>le</span>x</h1></div>
											<div class="card-sigin">
												<div class="main-signup-header">
													...
													<div class="main-signin-footer mt-5">
														...
														<p>Don't have an account? <a href="backend/page-signup.html">Create an Account</a></p>
													</div>
												</div>
											</div>
										</div>
