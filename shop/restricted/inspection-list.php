							...
							<div class="card mg-b-20">
								<div class="card-header pb-0">
									<div class="d-flex justify-content-between">
										<h4 class="card-title mg-b-0">Truck Inspection Information</h4>
										<i class="mdi mdi-dots-horizontal text-gray"></i>
									</div>
									<p class="tx-12 tx-gray-500 mb-2">View All Truck Inspection Information</p>
								</div>
								<div class="card-body">
									<div class="table-responsive">
                                        ...
                                        <tbody>
                                         <?php
												include("includes/inspection-list.php");
