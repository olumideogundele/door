	 ...
	 ?>
				   ...
				   <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <div class="form-group">
                                                    <label for="cono1" class="control-label col-form-label">User Type</label>
  <select class="form-control select2" style="width: 100%; height:36px;" name="usertype">
							 <?php
																...
																if(isset($_GET['value']))
												{
																	 ...
																	 echo $phone;
																echo " <option value=".$usertype.">".$usertypeValue."</option>"	;
																}
																else
																{
	  ...
	  <?php
		  ...
		  ?>
               <option value="9">Department Head</option>
