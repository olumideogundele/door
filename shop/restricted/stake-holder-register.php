...
?>
			<!-- main-sidebar -->
				...
				<!-- /main-header -->
                        ...
                        <div class="col-md-12">
                                      ...
                                      <?php
											include("includes/funab_sh_process.php");
							...
							<div class="card mg-b-20">
								<div class="card-header pb-0">
									<div class="d-flex justify-content-between">
										<h4 class="card-title mg-b-0">StakeHolder</h4>
										<i class="mdi mdi-dots-horizontal text-gray"></i>
									</div>
									<p class="tx-12 tx-gray-500 mb-2">Register Stakeholder</p>
								</div>
								<div class="card-body">
 ...
 <input type="text"  name="name" class="form-control"   placeholder="Stake Holder's Fullname" required>
					   
				   </div>
				    <div class="form-group">
                 <label>Phone:</label>
                
 <input type="text"  name="phone"  maxlength="11" class="form-control" id="exampleInputEmail1" placeholder="11 Digits Phone Number" required>
  ...
  <input type="email"  name="email" class="form-control" id="exampleInputEmail1" placeholder="Email Address" required>
				     ...
				     <div class="form-group">
                                           ...
                                           <select  class="form-control select2"   name="status" style="width: 100%; height:36px;" required>
                ...
                <button name = "validate" type="submit" class="btn btn-success mr-10">Submit</button>
						...
						<div class="col-xl-12">
							<div class="card mg-b-20">
								<div class="card-header pb-0">
									<div class="d-flex justify-content-between">
										<h4 class="card-title mg-b-0">Stakeholder Information</h4>
										<i class="mdi mdi-dots-horizontal text-gray"></i>
									</div>
									<p class="tx-12 tx-gray-500 mb-2">All Stakeholders Information</p>
								</div>
								<div class="card-body">
    ...
    <th>Name</th>
                                        ...
                                        <tbody>
                                        <?php
										include("includes/funab_sh_view.php");
