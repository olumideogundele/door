				...
				<!-- /main-header -->
                       ...
                       <div class="col-md-12">
                                            <div class="form-group">
                                             <?php
											include("includes/truck-capacity-charge-process.php");
							...
							<div class="card mg-b-20">
								<div class="card-header pb-0">
									<div class="d-flex justify-content-between">
										<h4 class="card-title mg-b-0">Truck Capacity Charge SetUp</h4>
										<i class="mdi mdi-dots-horizontal text-gray"></i>
									</div>
									<p class="tx-12 tx-gray-500 mb-2">Truck Capacity Charge SetUp</p>
								</div>
								<div class="card-body">
 	 ...
 	 while ($row_distance=mysqli_fetch_row($extract_distance))
    {
	 ...
	 ?>
		   ...
		   <div  id="response">       
                                         ...
                                         <div class="form-group overflow-hidden">
													<label>Price/Kilometer In Naira:</label>
							...
							<div class="card mg-b-20">
								...
								<div class="card-body">
									<div class="table-responsive">
                                        ...
                                        <tbody>
                                         <?php
												include("includes/view-truck-capacity-charge.php");
