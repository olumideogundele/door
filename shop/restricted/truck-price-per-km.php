				...
				<!-- /main-header -->
                       ...
                       <div class="col-md-12">
                                            <div class="form-group">
                                             <?php
											include("includes/price-per-km-process.php");
							...
							<div class="card mg-b-20">
								<div class="card-header pb-0">
									<div class="d-flex justify-content-between">
										<h4 class="card-title mg-b-0">Price Per Kilometer Price SetUp</h4>
										<i class="mdi mdi-dots-horizontal text-gray"></i>
									</div>
									<p class="tx-12 tx-gray-500 mb-2">Price Per Kilometer Price SetUp</p>
								</div>
								<div class="card-body">
							...
							<div class="card mg-b-20">
								...
								<div class="card-body">
									<div class="table-responsive">
                                        ...
                                        <tbody>
                                         <?php
												include("includes/view-price-per-km.php");
