				...
				<!-- /main-header -->
                       ...
                       <div class="col-md-12">
                                            <div class="form-group">
                                             <?php
											include("includes/radius-proccess.php");
							...
							<div class="card mg-b-20">
								<div class="card-header pb-0">
									<div class="d-flex justify-content-between">
										<h4 class="card-title mg-b-0">Truck Search Radius SetUp</h4>
										<i class="mdi mdi-dots-horizontal text-gray"></i>
									</div>
									<p class="tx-12 tx-gray-500 mb-2">Truck Search Radius SetUp</p>
								</div>
								<div class="card-body">
                        ...
                        <form     method="post"    autocomplete="off" action="" enctype="multipart/form-data">
                                         ...
                                         <div class="form-group overflow-hidden">
													<label>Radius (KILOMETER):</label>
 <input type="number" class="form-control" id="exampleInputuname_1" placeholder="In KMs" name="radius" value="">
												</div>
							...
							<div class="card mg-b-20">
								...
								<div class="card-body">
									<div class="table-responsive">
                                        ...
                                        <tbody>
                                         <?php
												include("includes/view-radius.php");
